...
ECHO BuildNightly: C:\WINDOWS\Microsoft.NET\Framework\v4.0.30319\msbuild.exe openXDA.buildproj /p:ForceBuild=true %logflag%
"C:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild.exe" openXDA.buildproj /p:ForceBuild=true %logFlag%