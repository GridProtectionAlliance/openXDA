...
SELECT
    ...
    FORMAT(Sag.MagnitudeVolts, '0') + ' volts' AS [Sag Magnitude (V)],
    FaultSummary.Algorithm,
    FORMAT(EventStat.VPeak, '0') + ' volts' AS [Voltage Peak],
    FORMAT(EventStat.VAMax, '0') + ' volts' AS [VA Maximum],
    FORMAT(EventStat.VBMax, '0') + ' volts' AS [VB Maximum],
    FORMAT(EventStat.VCMax, '0') + ' volts' AS [VC Maximum],
    FORMAT(EventStat.VABMax, '0') + ' volts' AS [VAB Maximum],
    FORMAT(EventStat.VBCMax, '0') + ' volts' AS [VBC Maximum],
    FORMAT(EventStat.VCAMax, '0') + ' volts' AS [VCA Maximum],
    FORMAT(EventStat.VAMin, '0') + ' volts' AS [VA Minimum],
    FORMAT(EventStat.VBMin, '0') + ' volts' AS [VB Minimum],
    FORMAT(EventStat.VCMin, '0') + ' volts' AS [VC Minimum],
    FORMAT(EventStat.VABMin, '0') + ' volts' AS [VAB Minimum],
    FORMAT(EventStat.VBCMin, '0') + ' volts' AS [VBC Minimum],
    FORMAT(EventStat.VCAMin, '0') + ' volts' AS [VCA Minimum],
    FORMAT(EventStat.IPeak, '0') + ' Amps' AS [Current Peak],
    FORMAT(EventStat.IAMax, '0') + ' Amps' AS [IA Maximum],
    FORMAT(EventStat.IBMax, '0') + ' Amps' AS [IB Maximum],
    FORMAT(EventStat.ICMax, '0') + ' Amps' AS [IC Maximum],
    FORMAT(EventStat.IA2t, '0') + ' (A^2)s' AS [IA2t],
    FORMAT(EventStat.IB2t, '0') + ' (A^2)s' AS [IB2t],
    FORMAT(EventStat.IC2t, '0') + ' (A^2)s' AS [IC2t],
    VAN.Mapping AS VAN,
    VBN.Mapping AS VBN,
    VCN.Mapping AS VCN,
    IAN.Mapping AS IAN,
