...
namespace WixFolderGen
{
    class Program
    {
        ...
        const string SolutionRelativeRootFolder = "Applications\\openXDA\\openXDA\\" + RootFolderName;

        // Following paths are relative to build output location
        const string ApplicationPath = "..\\..\\..\\..\\..\\Source\\Applications\\openXDA";
        const string SourceFolder = ApplicationPath + "\\openXDA\\" + RootFolderName;
        const string WebFeaturesDestinationFile = ApplicationPath + "\\openXDASetup\\WebFeatures.wxi";
        const string WebFoldersDestinationFile = ApplicationPath + "\\openXDASetup\\WebFolders.wxi";
        const string WebFilesDestinationFile = ApplicationPath + "\\openXDASetup\\WebFiles.wxi";
